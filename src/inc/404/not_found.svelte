    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center full-screen">
            <div class="col-12 col-xl-6 col-lg-7 col-md-8 text-center d-flex align-items-center justify-content-center flex-column">
                <h6 style="direction: rtl" class="alt-font text-fast-blue font-weight-600 letter-spacing-minus-1px margin-10px-bottom text-uppercase">ببخشید!!</h6>
                ...
                <span class="alt-font font-weight-500 text-extra-dark-gray d-block margin-20px-bottom">صفحه مورد نظر وجود ندارد</span>
                <a style="direction: rtl;color: #ffffff" href="/" class="btn btn-large btn-gradient-sky-blue-pink">بازگشت به خانه.</a>
            </div>
        </div>
    </div>
</section>