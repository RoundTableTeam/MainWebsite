        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-auto sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                <div class="d-flex justify-content-center align-items-center padding-15px-lr h-100">
                    <i class="feather icon-feather-phone align-middle icon-extra-small text-gradient-magenta-orange margin-10px-right"></i>
                    <span class="text-extra-dark-gray alt-font text-medium">{phone}</span>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-auto sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                <div class="d-flex justify-content-center align-items-center padding-15px-lr h-100">
                    ...
                    <a href="mailto:{email}" class="text-extra-dark-gray alt-font text-medium">{email}</a>
                </div>
            </div>
            <!-- end feature box item-->
            <!-- start feature box item-->
            <div class="col-12 col-sm-auto wow animate__fadeIn" data-wow-delay="0.6s">
                <div class="d-flex justify-content-center align-items-center padding-15px-lr h-100">
                    ...
                    <a href="https://{domain}" class="text-extra-dark-gray alt-font text-medium">{domain}</a>
                </div>
            </div>
            <!-- end feature box item-->
        </div>
